...
In questa approssimazione, cio\'e incontro breve, posso trascurare il moto del pianeta attorno alla stella. La traiettoria di un elemento di fluido \'e deviata di un angolo
\begin{equation}
...
Infine il momento torcente totale esercitato da pianeta sulla porzione esterna di disco \'e
\begin{equation}
\Gamma_{imp}==\int_{r_p+\Delta}^{\infty}\int_0^{2\pi}\frac{\delta j}{\delta t}\Sigma r\,d\theta\,dr\propto\Sigma q^2r_p^4\Omega_p^2\frac{r_p^3}{\Delta^3}
\end{equation}
...
low mass $q<\num{e-4.5}$: $x_s\propto m_p^2$, for massive planets $q>\num{e-4}$: $x_s\propto R_H$.
