...
\includegraphics[trim={0cm 19cm 0 0},clip, keepaspectratio,width=0.48\textwidth]{pdres}
\caption{Perturbazioni della densit\'a di un disco protoplanetaria causata da due pianeti in risonanza $2:1$. Da \cite{kley2012planet}.}\label{fig:pdres}
\end{wrapfigure}
