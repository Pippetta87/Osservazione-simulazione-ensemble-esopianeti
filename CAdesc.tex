...
\centering
\includegraphics[trim={0cm 10cm 0 0},clip, keepaspectratio,width=0.48\textwidth]{SED-contours}
...
\begin{subfigure}[b]{0.47\textwidth}
\centering
\includegraphics[trim={0cm 12cm 0 0},clip, width=0.9\textwidth,keepaspectratio]{clusterage-fstar}
