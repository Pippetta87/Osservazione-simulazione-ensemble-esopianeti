...
\begin{itemize}
\item Interazione con disco proto-planetario. Il potenziale periodico del pianeta perturba la densit\'a del gas: si ha scambio di momento angolare alle risonanze di Lindblad e alle orbite a ferro di cavallo.
...
\end{align}
Per piccole e,i e pianeta non abbastanza massiccio da aprire un gap attrono alla propria orbita il tempo di smorzamento di e,i \'e molto minore del tempo di migrazione radiale. 
Per il tempo caratteristico di migrazione radiale si ha:
\begin{equation}
\tau_m=\frac{r_p}{|\dot{r}_p|}=\frac{1}{2}\frac{J_p}{\Gamma}
\end{equation}
\cite{lubow2010planet} usando l'approssimazione impulsiva, valida per $\tau_{int}\ll\tau_{orb}$, hanno determinato l'ordine di grandezza del momento torcente subito dal pianeta. Per pianeti di piccola massa e distanza di interazione $H$
\begin{equation}
