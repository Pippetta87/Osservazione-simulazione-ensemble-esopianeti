...
Accresciuta la massa presente nella zona di pertinenza gravitazionale dell'embrione,detta isolation mass,
\begin{equation}M_{iso}\proptoM_*\expy{-1/2}\Sigma_p\expy{3/2}r^3\end{equation}
(higher radial excursion ae)
accrescimento oligarchico: $\frac{1}{M_e}\TDy{t}{M_e}\propto M_e\expy{-1/3}$.
da 100-1000km, \SI{e5}{\year}
