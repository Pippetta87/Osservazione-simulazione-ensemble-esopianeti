...
\begin{reworking}[Capitalit\'a modelli end2end: Non considero descrizione migrazione]
...
{\let\clearpage\relax\let\cleardoublepage\relax
	\chapter{Disco di accrescimento e condizioni iniziali}
}
...
\begin{reworking}[condizioni iniziali: soluzione equazione viscosa]
