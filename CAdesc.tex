{\let\clearpage\relax\let\cleardoublepage\relax
	\chapter{Simulazione crescita embrioni planetarii nello schema CA}
}

\begin{workout}[Generic intro to CA (chapter intro)]
...
\begin{workout}[Cos'\'e un disco di accrescimento?]
...
%{\let\clearpage\relax\let\cleardoublepage\relax
%\chapter{Dischi protoplanetarii}
%}
...
\begin{errata}[Massa, dimensioni polvere nei dischi protoplanetarii]
