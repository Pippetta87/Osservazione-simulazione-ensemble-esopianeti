...
\section{Migrazione tipo I: pianeti piccola massa}

\subsection{Momento torcente a risonanze di Lindblad e corotazone}
...
Integrando l'equazione \eqref{eq:pd-torue} si ottiene
\begin{align*}
