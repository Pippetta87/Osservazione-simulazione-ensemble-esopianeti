...
La struttura del disco protoplanetario determina la rapidit\'a di accrescimento degli embrioni planetari tramite la densit\'a di polvere influenzata a sua volta dalla posizione dell'iceline ($H_2O$): \'e possibile tenere traccia della frazione di roccie o ghiacci accrescuti. Le caratteristiche del disco influenzano la velocit\'a di migrazione degli embrioni.

La formazione di un inviluppo gassoso che inzialmente si raccorda alle condizioni del disco influenza la capacit\'a del pianeta di accrescere planetesimi e l'accrescimento di altro gas \'e regolato dalla velocit\'a di raffreddamento dell'embrione: raggiunta la massa critica per il collasso dell'inviluppo gassoso l'accrescimento \'e determinato dalla disponibilit\'a di gas del disco.
...
\caption{Simulazione popolazione planetaria di 504 sistemi Punti rossi: pianeti giganti con $M_e/M_c>1$; punti blu: pianeti che hanno accresciuto core oltre la iceline mentre i punti verdi all'interno dell'iceline. Da \cite{mordasini2018planetary}.}\label{fig:ma-synth}
\end{figure}
