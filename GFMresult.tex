...
\begin{figure}[!ht]
	\begin{subfigure}{0.48\textwidth}
		\includegraphics[trim={0cm 10cm 0 0},clip, keepaspectratio,width=\textwidth]{initdistro}
	...
	\end{subfigure}
	\begin{subfigure}{0.48\textwidth}
		\includegraphics[trim={9cm 5.5cm 10cm 0.5cm},clip, keepaspectratio, width=\textwidth]{GFM}
...
\begin{wrapfigure}[18]{l}{0.45\textwidth}
	\includegraphics[trim={17.5cm 10cm 16.5cm 0},clip, width=0.45\textwidth,keepaspectratio]{giant-Zsynth}
...
Le caratteristiche del disco protoplanetario determinano la rapidit\'a di accrescimento degli embrioni planetari  principalmente tramite la densit\'a di planetesimi: posizione dell'iceline ($H_2O$) fissa \'e coerente con approssimazione di trasformazione totalit\'a componente solida in planetesimi. La figura (\subref{fig:initdistro}) mostra la distribuzioni delle principali condizioni iniziali per la simulazione. La probabilit\'a di formare pianeti giganti aumenta con la metallicit\'a: la figura (\ref{fig:giant-Zsynth}) mostra che l'incremento relativo \'e in accordo con le osservazioni.
...
\end{subfigure}
\end{figure}
La posizione di Nettuno e Saturno nella figura (\subref{fig:ma-synth}) suggerisce che la posizione iniziale fosse probabilmente pi\'u interna (Grand-tack scenario).
...
%e la distribuzione sintetica cresce meno rapidamente a piccoli raggi.
