...
La distribuzione di massa e la distribuzione della stima delle et\'a \'e mostrata in \eqref{fig:initdistro}: si ha un fit ragionevole per $t_{disk}(\alpha,\Sigma_0,\dot{M}_w)$ per $\dot{M}_w=\SIrange{5e-10}{3e-8}\msun{}/\si{\year}$ per $\alpha=\num{7e-3}$
