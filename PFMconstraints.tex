...
\begin{figure}[!ht]
\includegraphics[trim={0cm 2cm 0 0cm},clip, width=0.9\textwidth]{Snebuladensity}\label{fig:Snebuladensity}\caption{Andamento minimum mass solar nebula (MMSN). Da \cite{weidenschilling1977distribution}.}
\end{figure}
...
\begin{wrapfigure}[10]{r}{0.4\textwidth} \includegraphics[trim={0cm 0 0 0},clip, width=0.4\textwidth]{MRC}\label{fig:MRC} \caption{Da \cite{perryman2011exoplanet}.} \end{wrapfigure}
