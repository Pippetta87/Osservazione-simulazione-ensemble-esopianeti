...
Il sistema solare \'e il punto di partenza delle teorie di formazione planetaria: il primo pianeta extra-solare \'e osservato nel 1995. Inoltre si hanno informazioni accurate sulle orbite planetarie e sulla popolazione di corpi minori, si hanno anche riferimenti temporali tramite analisi chimica dei meteoriti.

L'et\'a del sole \'e definita come tempo in sequenza principale; tecniche eliosismologiche e radiologiche determinano un'et\'a di \SI{4.57+-0.11}{\giga\year} e \SI{4.57+-0.07}{\giga\year}.
...
\begin{subfigure}[b]{0.47\textwidth}
\centering
\includegraphics[trim={0cm 0 0 0},clip,width=0.9\textwidth]{UNcomp}\label{tab:UNcomp}
\end{subfigure}
\caption{Composizione Giove, Saturno, Urano e Nettuno. Da \cite{baraffe2009physical}}
\end{table}

Il modello di Nizza del sistema solare riproduce caratteristiche orbitali dei pianeti giganti considerando la loro migrazione in una distribuzione di planentesimi di $30-50\mearth{}$. Ulteriori conferme della popolazione di planetesimi vengono dalla craterizzazionedei pianeti terrestri e corpi minori come dall'esistenza di numerosi oggetti di piccole dimensioni.4
...
\includegraphics[trim={0cm 0 0 0},clip, width=0.4\textwidth]{obsMa}\label{fig:Maplot}
...
\includegraphics[trim={0cm 0 0 0},clip, width=0.9\textwidth]{PMfreq-e23}
\caption{Da \cite{mayor2011harps}.}\label{fig:PMfreq-e23}
\end{subfigure}
~
\begin{subfigure}[b]{0.3\textwidth}
\includegraphics[trim={0cm 0 0 0},clip, width=0.9\textwidth]{PMfreq-e12}\label{fig:PMfreq-e12}
\caption{Da \cite{mayor2011harps}}
\end{subfigure}
~
\begin{subfigure}[b]{0.3\textwidth}
\includegraphics[trim={0cm 0 0 0},clip, width=0.9\textwidth]{PMfreq-short}\label{fig:PMfreq-short}
...
\begin{figure}[!ht]
\begin{subfigure}[b]{0.47\textwidth} \centering \includegraphics[trim={0cm 0 0 0},clip, width=0.\textwidth]{freqvsPgiant}\caption{Da \cite{ref}.}\label{fig:figref} \end{subfigure}
~
\begin{subfigure}[b]{0.\textwidth} \centering \includegraphics[trim={0cm 0 0 0},clip,width=\textwidth]{freqvsPlowM}\label{fig:figlabel} \caption{Da \cite{ref}.}
\end{subfigure}
\end{figure} 
...
\begin{figure}[!ht]
\includegraphics[trim={0cm 0 0 0},clip, keepaspectratio,width=0.9\textwidth]{freqvsRpl50d}
\end{figure}
