...
\begin{wrapfigure}[22]{r}{0.45\textwidth}
	\includegraphics[trim={6.4cm 5cm 6.5cm 0cm},clip, width=0.5\textwidth]{Snebuladensity}\caption{Andamento minimum mass solar nebula (MMSN). Da \cite{weidenschilling1977distribution}.}\label{fig:Snebuladensity}
\end{wrapfigure}
...
\begin{wrapfigure}[16]{l}{0.45\textwidth}
	\includegraphics[trim={0.1cm 4.5cm 0.7cm 0cm},clip, keepaspectratio,width=0.4\textwidth]{selfsimilaralphadisk-mod}
...
%\begin{figure}[9]{l}{0.7\textwidth}
\begin{figure}[!ht]
	\centering
	\includegraphics[trim={9.5cm 13cm 8cm 0.2cm},clip, width=0.69\textwidth,keepaspectratio]{clusterage-fstar}
...
\begin{figure}[!ht]
	\includegraphics[trim={0.1cm 0 0 0.1cm},clip, width=0.7\textwidth]{obsMa}
