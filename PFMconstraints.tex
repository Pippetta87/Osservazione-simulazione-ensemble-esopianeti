...
%\includegraphics[trim={0cm 0 0 0},clip, keepaspectratio,width=0.9\textwidth]{freqvsRpl50d}\label{Rfreq}\caption{Da \cite{exoplanet.eu}}
%\end{figure}

\begin{figure}[!ht] \begin{subfigure}[b]{0.47\textwidth} \centering \includegraphics[trim={0cm 0 0 0},clip, width=0.\textwidth]{RfreqPl100ub} \caption{Da \cite{fulton2017california}}\label{fig:figref} \end{subfigure} ~ \begin{subfigure}[b]{0.\textwidth} \centering \includegraphics[trim={0cm 0 0 0},clip,width=\textwidth]{keplerRfreq}\label{fig:figlabel} \caption{Da \cite{ref}} \end{subfigure} \end{figure} 
