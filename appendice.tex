\begin{reworking}[Periodi-RV: spostare in appendice]
	\begin{figure}[!ht]
		...
		\end{subfigure}
	\end{figure}
	; la distribuzione dei periodi mostra aumento dei pianeti giganti ($M>30\mearth{}$) a maggiore periodo orbitale (figura \subref{fig:freqvsPgiant}) e concentrazione pianeti piccola massa a $P=10-100\si{\day}$ (figura \subref{fig:freqvsPlowM})
\end{reworking}

\begin{reworking}[Periodi-T: distro e stopping mechanism]
...
\begin{reworking}[Fenomeni che causano migrazione]
	
{Evoluzione orbite proto-pianeti: migrazione planetaria.}
