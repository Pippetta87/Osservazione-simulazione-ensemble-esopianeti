...
Nei modelli globali la formazione planetaria \'e simulata partendo dalla fase finale di accrescimento di massa sulla stella centrale. Il variare delle caratteristiche dei sistemi planetari osservati sarebbe determinato dal variare delle condizioni iniziali: distribuzione di massa dei dischi protoplanetarii, metallicit\'a e tempo di vita, condizioni del cluster di cui faparte il disco.
...
Per costruire un modello di formazione globale \'e necessario introdurre una descrizione semplificata dei processi fisici che portano alla formazione di un pianeta; quindi generare una popolazione planetaria a partire da un gran numero di combinazioni di condizioni iniziali determinate casualmente distribuite in accordo alle osservazioni.
