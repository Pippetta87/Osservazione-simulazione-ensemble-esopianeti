...
Alcuni dati osservativi riguardo al sistema solare lasciano ipotizzare che il primo modello sia il canale di formazione preponderante (\begin{workout}[cit osservazioni pro CA: lissauer 93]\end{workout}) per sistemi planetari attorno a stella singola di sequenza principale:
