...
\definecolor{dollarbill}{rgb}{0.52, 0.73, 0.4}%reworking
...
\definecolor{midnightblue}{rgb}{0.1, 0.1, 0.44}%workout
...
\begin{workout}[comando]
Mantengo una riserva generale: c'e' troppa roba; sembra un riassunto di
appunti per un corso di almeno 20 ore.... Dovra' fare un lavoro molto
impegnativo per scegliere che cosa raccontare nei ~30 minuti del
seminario. Pero' non voglio farle perdere troppo tempo, e usiamo la sua
versione come base, dopo pero' alcuni miglioramenti essenziali:

- Figure e tabelle vanno spiegate bene; per esempio nella tab 1-1 che
cosa e' MZtot?
La fig. 1.3 non mi e' chiara
Quale e' la differenza fra 1-4a e 1-4b?
La figura 1-8 e' troppo piccola e non si capisce molto
Le figure 2-3a e b (e analogamente le 3-3a e b) sono troppo piccole e
la didascalia e' insufficiente

correggere gli errori di battitura: es: kilometriche invece di
chilometriche pag. 11
...
\begin{errata}[Intro scenario CS (prima di Sistema solare)]
...
%\begin{reworking}[Scenario core accretion]
\begin{figure}[!ht]
...
L'ipotesi su cui si basano le simulazioni considerate \'e che la componente polverosa formi corpi pi\'u massicci fino a masse di frazioni di masse terrestri  ed eventualmente, per corpi sufficientemente massicci, accresca gas: lo scenario di core accretion (CA). Lo schema di formazione alternativo considera l'instabilit\'a gravitazionale del disco protoplanetario.
%\end{reworking}
