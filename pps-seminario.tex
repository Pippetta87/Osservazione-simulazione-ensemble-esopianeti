...
Cosa ho messo nel modello e2e?
Massa critica per accrescimento di gas: tempo scala accrescimento planetesimi vs tempo scala disco.
Tempi scala migrazione
\item distribuzione in semiassi che dipende da posizione iniziale embrione: necessity to include earlier planetary formation; montecarlo variable: initial starting position embryos- kokubo ida 00: uniform distro in log(a) (vedi anche ida lin 10); hasegawa pudritz 11, cridland 16: embryos rapidly moves into traps.
...
Disc/planetesimals parameters: planetesimal has steeper profile $\propto r\expy{-3/2}$, outer exponential radius half that of gas: inward drift of dust (kornet 01, birnstiel Andrews 14), concentrated distro resulting from planetesimal formation (Drazkowska 16); planetesimal size is 300m, $\alpha=0.002$.
...
\begin{workout}[frammentazione di nube molecolare e form azione di disco di accrescimento attorno a stella giovane]
...
Alcuni dati osservativi riguardo al sistema solare lasciano ipotizzare che il primo modello sia il canale di formazione preponderante (\begin{workout}[cit osservazioni pro CA: lissauer 93 vs nayaskin16+ vs safronov 72]\end{workout}) per sistemi planetari attorno a stella singola di sequenza principale:
